...
import com.ms.tet.databinding.ActivityTabuleiroBinding
import com.ms.tet.parts.*
...
class Table : AppCompatActivity() {
    ...
    fun novaPeca(tipo:Int):Part{
        var cor = aleatorio.nextInt(9);
        when (tipo) {
            0 -> {
                return Part_O(Point(1,12), cor);
            }
            1 -> {
                return Part_I(Point(4,12), cor);
            }
            2 -> {
                return Part_S(Point(2,12), cor);
            }
            3 -> {
                return Part_T(Point(1,12), cor);
            }
            4 -> {
                return Part_L(Point(3, 12), cor);
            }
            else -> {
                return  Part_X(Point(2,12), cor);
            }
        }
    }
